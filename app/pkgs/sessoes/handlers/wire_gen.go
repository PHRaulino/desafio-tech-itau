...
func InitializeHandler(db *sql.DB) *SessoesHandler {
	...
	criaPedidoUseCase := usecases2.NewCriaPedidoUseCase(sqlLiteRepoPedidos)
	sqlLiteRepoIngressos := adapters3.NewSQLLiteRepoIngresso(db)
	criaIngressoUseCase := usecases3.NewCriaIngressoUseCase(sqlLiteRepoIngressos)
	adicionaItemPedidoUseCase := usecases2.NewAdicionaItemPedidoUseCase(sqlLiteRepoPedidos)
	...
	criaReservaUseCase := usecases.NewCriaReservaUseCase(cacheEmMemoriaRepoReservas, criaPedidoUseCase, criaIngressoUseCase, adicionaItemPedidoUseCase, atualizaIngressoUseCase, buscaIngressoUseCase)
