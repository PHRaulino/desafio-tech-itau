...
func InitializeHandler(db *sql.DB) *SessoesHandler {
	...
	criaReservaUseCase := usecases.NewCriaReservaUseCase(cacheEmMemoriaRepoReservas, iCriaPedidoUseCase, criaIngressoUseCase, iAdicionaItemPedidoUseCase, atualizaIngressoUseCase, buscaIngressoUseCase)
